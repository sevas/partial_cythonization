...
def obfuscate_package(
    src: str | Path, dest: str | Path, compile_all: bool = False, clean: bool = False, include_data=None
):
    ...
    def should_include_data(fp):
        for pat in include_data:
